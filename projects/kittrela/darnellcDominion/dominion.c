...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  // Change switch statement to 5 individual cards. 
  ...
  switch( card ) 
    {
     ...
     case adventurer:
          ...
          return playAdventurer( &drawntreasure, state, &currentPlayer, &cardDrawn, &z, temphand);
          return 0;
 ...
 case feast:
    ...
    case embargo: 
      ...
      playEmbargo(choice1, currentPlayer, state, handPos); 
      return 0;
 //      //+2 Coins
 //      state->coins = state->coins + 2;
...
int playEmbargo(int choice1, int currentPlayer, struct gameState *state, int handPos)
{
  //+2 Coins
